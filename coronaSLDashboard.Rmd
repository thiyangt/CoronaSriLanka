...
datalatest  <- c(1, rep(0, 43), 1L, 2L,2L, 5L, 8L, 10L, 13L, 11L, 13L, 6L,                                     6L, 9L, 10L, 5L, 0L, 4L)
cumsum <- cumsum(datalatest)

dfSL <- data.frame(corona_SL <- data.frame(date = seq(as.Date("2020-1-27"), as.Date("2020-3-26"), by="days"),
...
#--- Summary Numbers
Date <- c("2020-3-24", "2020-3-25", "2020-3-26")
confirmedValue <- c(102, 102, 106)
hospitalValue <- c(255, 237, 237)
recoveredValue <- c(3, 3, 6)
deathValue <- c(0, 0, 0)
```
