...
plotly::plot_ly(data = df_daily) %>%
  ...
  plotly::add_annotations(
    ...
    y = 1,
    text = paste("First case (Nationality: China, Orign: Wuhan, China)"),
    xref = "x",
    yref = "y",
    arrowhead = 5,
    arrowhead = 3,
  ...
  plotly::add_annotations(
    ...
    y = 3,
    text = paste("First Sri Lankan (Tour guide, Origin: Italy)"),
    xref = "x",
    yref = "y",
    arrowhead = 5,
    arrowhead = 3,
...
[Dr Thiyanga Talagala](https://thiyanga.netlify.com/)
